...
q4.svm <- svm(CAND_ID~., data = train, kernel = "radial")
q4.svm.train.accuracy <- mean((predict(q4.svm, train) > 0.5) == train$CAND_ID)
q4.svm.test.accuracy <- mean((predict(q4.svm, test) > 0.5) == test$CAND_ID)
